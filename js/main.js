...
(function() {
  var boardIsFull, buildBoard, calculateScore, collapseCells, generateTile, getColumn, getRow, isGameOver, mergeCells, move, moveIsValid, noValidMoves, printArray, randomCellIndices, randomInteger, randomValue, setColumn, setRow, showBoard,
  ...
  calculateScore = function(array) {
    var elem, row, score, _i, _j, _len, _len1;
    score = 0;
