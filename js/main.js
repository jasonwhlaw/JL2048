...
(function() {
  var boardIsFull, buildBoard, collapseCells, generateTile, getColumn, getRow, isGameOver, mergeCells, move, moveIsValid, noValidMoves, printArray, randomCellIndices, randomInteger, randomValue, resetToZero, setColumn, setRow, showBoard, updateScore,
      ...
      for (a = _i = 3; _i > 0; a = --_i) {
        for (b = _j = _ref = a - 1; _ref <= 0 ? _j <= 0 : _j >= 0; b = _ref <= 0 ? ++_j : --_j) {
          if (cells[a] === 0) {
            ...
            cells[a] *= 2;
            cells[b] = 0;
            updateScore(this.score += cells[a]);
            break;
          } else if (cells[b] !== 0) {
            break;
          }
  ...
  updateScore = function() {
    return $('h3.score').html(this.score);
  };
  ...
  $(function() {
    ...
    $('.reset').click((function(_this) {
      return function() {
        ...
        return _this.score = resetToZero();
      };
    })(this));
        ...
        if (__indexOf.call(keys, key) >= 0) {
          ...
          if (moveIsValid(_this.board, newBoard)) {
            ...
            if (isGameOver(_this.board)) {
              $(".board").fadeOut(2000);
              return $("#gameOverScreen").delay(2000).fadeIn(1000);
            } else {
